// ============================================================
// REEL STUDIO PAGE - Embedded Interactive Planner
// ============================================================
...
export default function ReelStudioPage() {
  useDocumentTitle("Reel Studio | Vignesh M");
      ...
      <main className="pt-24 pb-8 px-3 sm:px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-gray-100 dark:border-neutral-800 overflow-hidden">
            <iframe
              src="/reel-studio.html"
              title="Reel Studio - 250 Day Plan"
              className="w-full border-0"
              style={{ height: "calc(100vh - 170px)", minHeight: "720px" }}
